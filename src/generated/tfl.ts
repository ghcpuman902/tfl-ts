...
/** The cycle preference. eg possible options: "allTheWay" | "leaveAtStation" | "takeOnTransport" | "cycleHire" */
export type CyclePreferenceEnum =
  | 'None'
  | 'LeaveAtStation'
  | 'TakeOnTransport'
  | 'AllTheWay'
...
/** The journey preference eg possible options: "leastinterchange" | "leasttime" | "leastwalking" */
export type JourneyJourneyResultsParams1JourneyPreferenceEnum =
  | 'LeastInterchange'
  | 'LeastTime'
  | 'LeastWalking';
 ...
 */
  ...
  journey = {
    ...
    journeyJourneyResults: (
      { from, to, ...query }: JourneyJourneyResultsParams,
  ...
  line = {
     ...
     */
    lineLineRoutesByIds: (
      { ids, ...query }: LineLineRoutesByIdsParams,
      params: RequestParams = {}
    ) =>
      this.request<TflApiPresentationEntitiesLine[], any>({
        path: `/Line/${ids}/Route`,
     ...
     */
    lineRouteSequence: (
      { id, direction, ...query }: LineRouteSequenceParams,
      params: RequestParams = {}
    ) =>
     ...
     */
    lineStatus: (
      { ids, startDate, endDate, ...query }: LineStatusParams,
      params: RequestParams = {}
    ) =>
      this.request<TflApiPresentationEntitiesLine[], any>({
 ...
 */
     ...
     */
    lineArrivals: (
      { ids, stopPointId, ...query }: LineArrivalsParams,
      params: RequestParams = {}
    ) =>
 ...
 */
  ...
  place = {
    ...
    placeGetStreetsByPostCode: (
      { postcode, ...query }: PlaceGetStreetsByPostCodeParams,
      params: RequestParams = {}
    ) =>
      this.request<SystemObject, any>({
 ...
 */
  ...
  road = {
     ...
     */
    roadDisruptionById: (
      { disruptionIds, ...query }: RoadDisruptionByIdParams,
      params: RequestParams = {}
    ) =>
      this.request<TflApiPresentationEntitiesRoadDisruption, any>({
 ...
 */
  ...
  stopPoint = {
     ...
     */
    stopPointCrowding: (
      { id, line, ...query }: StopPointCrowdingParams,
      params: RequestParams = {}
    ) =>
      this.request<TflApiPresentationEntitiesStopPoint[], any>({
    ...
    stopPointArrivalDepartures: (
      { id, ...query }: StopPointArrivalDeparturesParams,
      params: RequestParams = {}
    ) =>
    ...
    stopPointReachableFrom: (
      { id, lineId, ...query }: StopPointReachableFromParams,
      params: RequestParams = {}
    ) =>
      this.request<TflApiPresentationEntitiesStopPoint[], any>({
    ...
    stopPointDisruptionByMode: (
      { modes, ...query }: StopPointDisruptionByModeParams,
      params: RequestParams = {}
    ) =>
     ...
     */
    stopPointDisruption: (
      { ids, ...query }: StopPointDisruptionParams,
      params: RequestParams = {}
    ) =>
      this.request<TflApiPresentationEntitiesDisruptedPoint[], any>({
     ...
     */
    stopPointDirection: (
      { id, toStopPointId, ...query }: StopPointDirectionParams,
      params: RequestParams = {}
    ) =>
      this.request<string, any>({
     ...
     */
    stopPointGetByMode: (
      { modes, ...query }: StopPointGetByModeParams,
      params: RequestParams = {}
    ) =>
      this.request<TflApiPresentationEntitiesStopPointsResponse, any>({
     ...
     */
    stopPointSearch: (
      { query, ...queryParams }: StopPointSearchParams,
      params: RequestParams = {}
    ) =>
      this.request<TflApiPresentationEntitiesSearchResponse, any>({
    ...
    travelTimeGetCompareOverlay: (
      {
        ...
        height,
        ...query
      }: TravelTimeGetCompareOverlayParams,
      params: RequestParams = {}
    ) =>
      this.request<SystemObject, any>({
